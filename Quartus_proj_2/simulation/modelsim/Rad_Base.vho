...
-- Equation(s):
-- \DEecoder|READ_WORD|word_inner[2]~12_combout\ = !\DEecoder|READ_WORD|count_status\(0) & !\RES~dataout\ & \DEecoder|READ_WORD|sync_inner~regout\
...
-- Equation(s):
-- \DEecoder|READ_WORD|count\(2) = DFFEA(!\Coder|Form_word|OUT_WORD~combout\ & (\DEecoder|READ_WORD|count\(2) $ (\DEecoder|READ_WORD|count\(0) & \DEecoder|READ_WORD|count\(1))), GLOBAL(\CLK~dataout\), !GLOBAL(\RES~dataout\), , , , )
...
-- Equation(s):
-- \DEecoder|READ_WORD|count\(1) = DFFEA(!\Coder|Form_word|OUT_WORD~combout\ & (\DEecoder|READ_WORD|count\(0) $ \DEecoder|READ_WORD|count\(1)), GLOBAL(\CLK~dataout\), !GLOBAL(\RES~dataout\), , , , )
...
-- Equation(s):
-- \DEecoder|READ_WORD|count\(0) = DFFEA(!\DEecoder|READ_WORD|count\(0) & !\Coder|Form_word|OUT_WORD~combout\ & (!\DEecoder|READ_WORD|count\(2) # !\DEecoder|READ_WORD|count\(1)), GLOBAL(\CLK~dataout\), !GLOBAL(\RES~dataout\), , , , )
...
-- Equation(s):
-- \DEecoder|READ_WORD|count_status\(1) = DFFEA(\DEecoder|READ_WORD|count_status\(1) $ \DEecoder|READ_WORD|count_status\(0), GLOBAL(\CLK~dataout\), !GLOBAL(\RES~dataout\), , \DEecoder|READ_WORD|sync_inner~regout\, , )
...
-- Equation(s):
-- \DEecoder|READ_WORD|count_status\(2) = DFFEA(\DEecoder|READ_WORD|count_status\(2) $ (\DEecoder|READ_WORD|count_status\(1) & \DEecoder|READ_WORD|count_status\(0)), GLOBAL(\CLK~dataout\), !GLOBAL(\RES~dataout\), , \DEecoder|READ_WORD|sync_inner~regout\, , )
...
-- Equation(s):
-- \DEecoder|READ_WORD|OUT_WORD[0]~3_combout\ = \DEecoder|READ_WORD|count_status\(1) & \DEecoder|READ_WORD|count_status\(2) & \DEecoder|READ_WORD|count_status\(0) & \DEecoder|READ_WORD|sync_inner~regout\
...
-- pragma translate_on
PORT MAP (
	dataa => \DEecoder|READ_WORD|count_status\(1),
	datab => \DEecoder|READ_WORD|count_status\(2),
	datac => \DEecoder|READ_WORD|count_status\(0),
	datad => \DEecoder|READ_WORD|sync_inner~regout\,
	devclrn => ww_devclrn,
...
-- Equation(s):
-- \DEecoder|READ_WORD|SYNC~regout\ = DFFEA(\DEecoder|READ_WORD|count_status\(0) & \DEecoder|READ_WORD|count_status\(1) & \DEecoder|READ_WORD|count_status\(2), GLOBAL(\CLK~dataout\), !GLOBAL(\RES~dataout\), , \DEecoder|READ_WORD|sync_inner~regout\, , )
